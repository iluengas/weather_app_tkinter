...
class SearchBar(tk.Frame):
    ...
    def configure_search_entry(self):
        ...
        self.search_entry.pack(side=tk.LEFT, padx=(1, 5), pady=(5, 5))
        self.search_entry.configure(width=57, font=("Arial", 24))
        self.search_entry.insert(0, self.default_text)

        # Search Button
        search_image = Image.open("Images/search.png").resize((35, 33))
        ...
        search_button.pack(side=tk.LEFT, pady=(5, 5), padx=(0, 5))
        ...
        celsius_button.pack(side=tk.LEFT, pady=(5, 5), padx=(0, 5))
        ...
        fahrenheit_button.pack(side=tk.LEFT, pady=(5, 5), padx=(0, 5))
    ...
    def city_not_found(self):
        ...
        self.error_frame.pack(pady=(30, 0), padx=250)
